...
# temporary files
OUTPUT1=$HOME/.xplanet/xplanet1.png
OUTPUT2=$HOME/.xplanet/xplanet2.png
...
case $1 in
	...
	("--clouds")
		...
		if [ -e clouds.jpg ]; then
			...
			wget --no-cache -O clouds.jpg http://xplanetclouds.com/free/coral/clouds_2048.jpg
		fi
		exit;;
	("--init")
		...
		cd $BASE/backgrounds
		wget -O 00_full.jpg http://veimages.gsfc.nasa.gov/1438/earth_lights_lrg.jpg >/dev/null 2>&1
		wget -O 01_full.jpg http://veimages.gsfc.nasa.gov/7100/world.topo.bathy.200401.3x5400x2700.jpg >/dev/null 2>&1
		wget -O 02_full.jpg http://veimages.gsfc.nasa.gov/7101/world.topo.bathy.200402.3x5400x2700.jpg >/dev/null 2>&1
		wget -O 03_full.jpg http://veimages.gsfc.nasa.gov/7102/world.topo.bathy.200403.3x5400x2700.jpg >/dev/null 2>&1
		wget -O 04_full.jpg http://veimages.gsfc.nasa.gov/7103/world.topo.bathy.200404.3x5400x2700.jpg >/dev/null 2>&1
		wget -O 05_full.jpg http://veimages.gsfc.nasa.gov/7104/world.topo.bathy.200405.3x5400x2700.jpg >/dev/null 2>&1
		wget -O 06_full.jpg http://veimages.gsfc.nasa.gov/7105/world.topo.bathy.200406.3x5400x2700.jpg >/dev/null 2>&1
		wget -O 07_full.jpg http://veimages.gsfc.nasa.gov/7106/world.topo.bathy.200407.3x5400x2700.jpg >/dev/null 2>&1
		wget -O 08_full.jpg http://veimages.gsfc.nasa.gov/7107/world.topo.bathy.200408.3x5400x2700.jpg >/dev/null 2>&1
		wget -O 09_full.jpg http://veimages.gsfc.nasa.gov/7108/world.topo.bathy.200409.3x5400x2700.jpg >/dev/null 2>&1
		wget -O 10_full.jpg http://veimages.gsfc.nasa.gov/7109/world.topo.bathy.200410.3x5400x2700.jpg >/dev/null 2>&1
		wget -O 11_full.jpg http://veimages.gsfc.nasa.gov/7110/world.topo.bathy.200411.3x5400x2700.jpg >/dev/null 2>&1
		wget -O 12_full.jpg http://veimages.gsfc.nasa.gov/7111/world.topo.bathy.200412.3x5400x2700.jpg >/dev/null 2>&1
...
do
	...
	# resize picture
	convert $OUTPUT -resize ${RESOLUTION}^ -support 0.00001 -gravity center -extent $RESOLUTION ${OUTPUT}.t
	mv ${OUTPUT}.t $OUTPUT

	# update Gnome backgound
	$TEST gsettings set org.gnome.desktop.background picture-uri "file://$OUTPUT"
